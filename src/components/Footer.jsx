...
const socialLinks = [
  ...
  { label: 'WhatsApp', href: 'https://wa.me/8801700000000', icon: 'M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z' },
  { label: 'Email', href: 'mailto:info@assz.com', icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
];
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            address: {
              '@type': 'PostalAddress',
              streetAddress: 'A.K Zaman Plaza, Ataikula',
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-text-secondary">
              <li className="flex items-start gap-2">
                ...
                <span>A.K Zaman Plaza, Ataikula, Pabna</span>
              </li>
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:info@assz.com" className="hover:text-white transition-colors">info@assz.com</a>
              </li>
              <li className="flex items-center gap-2">
