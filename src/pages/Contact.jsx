...
const contactMethods = [
  {
    title: 'Visit Us',
    lines: ['A.K Zaman Plaza, Ataikula', 'Pabna, Bangladesh'],
    icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0zM15 11a3 3 0 11-6 0 3 3 0 016 0z',
  },
  {
    title: 'Call / WhatsApp',
    lines: ['+880 1700-000000', 'Sat–Thu: 10 AM – 8 PM'],
    icon: 'M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z',
    action: { label: 'Call Now', href: 'tel:+8801700000000' },
  },
  {
    title: 'Email Us',
    lines: ['info@assz.com', 'We reply within 24 hours'],
    icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z',
    action: { label: 'Send Email', href: 'mailto:info@assz.com' },
  },
  {
    ...
    action: { label: 'Chat Now', href: 'https://wa.me/8801700000000' },
  },
];
        ...
        <div className="grid md:grid-cols-5 gap-10">
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="bg-surface rounded-xl border border-border overflow-hidden h-64">
              <div className="w-full h-full bg-bg dark:bg-surface flex items-center justify-center">
                <div className="text-center px-6">
                  ...
                  <p className="text-sm font-medium text-text-primary">A.K Zaman Plaza, Ataikula</p>
                  <p className="text-xs text-text-secondary mt-1">Pabna, Bangladesh</p>
                  <a href="https://maps.google.com/?q=A.K+Zaman+Plaza+Ataikula+Pabna" target="_blank" rel="noopener noreferrer" className="inline-block mt-3 text-xs font-semibold text-accent hover:underline">
            ...
            <div className="bg-surface rounded-xl border border-border p-6">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-text-secondary">Saturday – Thursday</span>
                  <span className="font-medium">10:00 AM – 8:00 PM</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-text-secondary">Friday</span>
            ...
            <div className="bg-accent/5 rounded-xl border border-accent/10 p-6 text-center">
              ...
              <a href="https://wa.me/8801700000000" target="_blank" rel="noopener noreferrer" className="btn-primary text-sm !bg-[#25D366] hover:!bg-[#128C7E]">
